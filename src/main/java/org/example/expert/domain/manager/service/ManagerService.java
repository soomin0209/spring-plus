...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            // 매니저 등록 성공 로그 저장
            logService.saveLog(todoId, user.getId(), managerUser.getId(), true, null);
            ...
            // 매니저 등록 실패 로그 저장
            logService.saveLog(todoId, user.getId(), managerSaveRequest.getManagerUserId(), false, e.getMessage());
            throw e;
        }
    }
